...
const float SCREEN_WIDTH = 800; //800 XXX
...
void display(void)
{
    ...
    {
        //Fill the screen
        glViewport( 0.f, 0.f, SCREEN_WIDTH, SCREEN_HEIGHT*0.75 );
    ...
    {
        //Center viewport
        glViewport( SCREEN_WIDTH / 4.f, SCREEN_HEIGHT / 4.f, SCREEN_WIDTH / 2.f, SCREEN_HEIGHT * 0.5f );
